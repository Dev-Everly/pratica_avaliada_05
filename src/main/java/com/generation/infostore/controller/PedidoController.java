...
public class PedidoController {
	...
	public ResponseEntity<List<Pedido>> getByNome(@PathVariable String produto){
    ...
    public ResponseEntity<Pedido> post(@Valid @RequestBody Pedido pedido) {
        ...
        if (pedido.getCliente() == null || pedido.getCliente().getId() == null || 
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "O Cliente informado não existe!", null);
        }
    ...
    public ResponseEntity<Pedido> put(@Valid @RequestBody Pedido pedido) {
         ...
         if (pedido.getId() == null) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "O ID do pedido é obrigatório para atualização!", null);
        }
        ...
        throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Pedido não encontrado!", null);
    }
